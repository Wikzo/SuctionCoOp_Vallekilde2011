	...
	void Update ()
    {
        ...
        switch (Player1State)
        {
            ...
            case State.Falling:
                ...
                hinges[0].connectedBody = empty1.rigidbody; // connected body = sig selv --> falder ned
        ...
        switch (Player2State)
        {
            ...
            case State.Falling:
				...
				hinges[1].connectedBody = empty2.rigidbody; // connected body = sig selv --> falder ned
